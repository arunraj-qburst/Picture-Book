...
var _reactNativeResponsive=require('react-native-responsive');var React=require('react-native');

var WIDTH=_reactNative.Dimensions.get('window').width;
var HEIGHT=_reactNative.Dimensions.get('window').height;

console.log(_reactNative.Dimensions.get('window'));
var styles=_reactNativeResponsive.MediaQueryStyleSheet.create({
itemWrapper:{
height:205,
flexGrow:1,
margin:5},
